<?php
  ...
  $pdo_prepare = $pdo->prepare("SELECT * FROM orders WHERE total_price >= :purchase_amount ORDER BY id DESC");
  $pdo_prepare->execute(
    array(
      ':purchase_amount' => $purchased_amount,
    )
  );
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                <table id="royalCustomer" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Customers</th>
                            <th>Total Amount</th>
